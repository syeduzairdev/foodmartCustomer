...
import 'package:untitled3/drawer_screens/impression_screen.dart';
      ...
      body: Container(
        ...
        child: Column(
          children: [
            ...
            Text(
              'Lorem ipsum dolor sit amet, consectetur adipiscing elit. Nisi, a, viverra id egestas. Quisque ut orci sodales adipiscing. Et bibendum mauris, vestibulum diam. Donec lacus, eleifend sagittis pellentesque ac consequat, odio viverra. Sit id lectus sit accumsan. Volutpat enim feugiat nis',
                  ...
                  Transform.scale(
                    ...
                    child: SizedBox(
                      ...
                      child: Checkbox(
                          ...
                          checkColor: Color.fromRGBO(22, 97, 207, 10),
              ...
              child: MaterialButton(
                ...
                onPressed: () {
                  Navigator.push(
                    context,
                    MaterialPageRoute(
                        builder: (context) => impression_screen()),
                  );
                },
              ),
            ),
